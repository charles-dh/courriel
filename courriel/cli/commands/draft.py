...
def draft(
    ...
    body: Annotated[
        str | None, typer.Option("--body", help="Email body (or read from stdin)")
    ] = None,
    reply_to: Annotated[
        str | None, typer.Option("--reply-to", help="Reply to message ID")
    ] = None,
    attach: Annotated[
        list[str] | None, typer.Option("--attach", help="Attach file(s)")
    ] = None,
):
